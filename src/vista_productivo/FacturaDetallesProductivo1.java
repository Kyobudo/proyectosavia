...
public class FacturaDetallesProductivo1 extends javax.swing.JFrame {

    DefaultTableModel mtDetalles;
    DefaultTableModel mtGlosaRespuesta;
    DefaultTableModel mtGlosaDetalles;

    public FacturaDetallesProductivo1() {
        initComponents();
    ...
    private static final Logger LOG = Logger.getLogger(FacturaDetallesProductivo1.class.getName());
    ...
    private void btnBusquedafacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBusquedafacturaActionPerformed
        ...
        if (numeroIdFactura.isEmpty()) {//mensaje en caso de que no ingresen datos para la busqueda
            JOptionPane.showMessageDialog(FacturaDetallesProductivo1.this, "Por favor ingrese todos los datos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaDetallesProductivo1().setVisible(true);
            }
        });
    }
