...
public class AuditodiaMotivosGlosaProduc extends javax.swing.JFrame {

    DefaultTableModel mt = new DefaultTableModel();

    //talbla auditoria motivos glosa
    public AuditodiaMotivosGlosaProduc() {
        initComponents();
        String[] arreglo_colunm = {"id", "cm_detalles_id", "Motivo valor", "Motivo especifico", "Porcentaje",
            "Valor motivo", "Observacion"};//llena los encabezados de la tabla con el array
        mt.setColumnIdentifiers(arreglo_colunm);
        tableauditoriamotivos.setModel(mt);
        int[] tamamo_colum_auditoria = {90, 150, 100, 200, 100, 100, 600};//tamaño de las columnas
                ...
                if (rs.next()) {
                    do {
                        Object[] rowData = {//lista de columnas de la cm_auditoria_motivos_glosa que se necesitan
                            ...
                            rs.getString("mae_motivo_valor"),
                            rs.getString("mae_motivo_especifico_valor"),
                            rs.getDouble("porcentaje"),
                            rs.getDouble("valor_motivo"),
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new AuditodiaMotivosGlosaProduc().setVisible(true);
            }
        });
    }
