...
public class FacturaDetallesProductivo extends javax.swing.JFrame {
    ...
    DefaultTableModel mtGlosa_Respuesta_Detalles;
    ...
    public FacturaDetallesProductivo() {
        ...
        mtGlosa_Respuesta_Detalles = (DefaultTableModel) tableGlosaDetalles.getModel();
    ...
    public void busquedaDetalles(String id, String query) {//aqui se busca los datos de la factura en la base de datos somos mas
    ...
    public void buscarDetallesGlosa(String numeroid) {
        Connection con = conexionesBD.ConexionProductivo.getConnection();
        if (con != null) {
            ...
            try ( PreparedStatement pst = con.prepareStatement(query)) {
                pst.setString(1, numeroid);
                ResultSet rs = pst.executeQuery();
                mtGlosa_Respuesta_Detalles.setRowCount(0);
                System.out.println(numeroid);
                if (rs.next()) {
                    do {
                        Object[] rowData = {
                            ...
                            rs.getDouble("valor_cobro_detalle"),
                            rs.getDouble("valor_facturado"),};
                        mtGlosa_Respuesta_Detalles.addRow(rowData);
                    } while (rs.next());
                } else {
                    JOptionPane.showMessageDialog(this, "No se encontraron resultados en la tabla glosa respuesta", "Resultado", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    private void initComponents() {
        ...
        tableDetalles.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "cm_facturas_id", "mae_tipo_doc_valor", "documento", "Nombre afiliado", "ma_servicio_valor", "Radicado glosa", "Valor copago", "Valor facturado", "Valor unitario", "Valor pagado", "Valor pendiente", "Valor pendiente actual", "Valor aceptado IPS", "Observacion", "Valor pagado EPS", "Porcentaje pagado EPS", "Porcentaje aceptado IPS", "Observacion respuesta detalles", "Fecha de prestacion", "Valor copago item", "Valor glosa", "Concepto contable", "Fecha creacion"
            }
        ) {
        ...
        tableGlosaRespuesta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                RespuestaDetalleGlosa(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 3000, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnPaginaIncialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPaginaIncialActionPerformed
        ...
        FacturaDetallesProductivo Cerrar = new FacturaDetallesProductivo();
    ...
    private void RespuestaDetalleGlosa(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RespuestaDetalleGlosa
        DefaultTableModel model = (DefaultTableModel) tableGlosaRespuesta.getModel();
        int SelectedRowIndex = tableGlosaRespuesta.getSelectedRow();
        String id = model.getValueAt(SelectedRowIndex, 0).toString();
        buscarDetallesGlosa(id);
        
    }//GEN-LAST:event_RespuestaDetalleGlosa
