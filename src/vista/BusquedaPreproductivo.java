...
public class BusquedaPreproductivo {
    
public void buscarDatosProductivo(DefaultTableModel mt_preproductivo, String numeroFactura, String nit) {
        ...
        if (con != null) {
            ...
            try (PreparedStatement pst = con.prepareStatement(query)) {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No se encontraron resultados en BD Pre productiva", "Resultado", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (SQLException e) {
                e.printStackTrace();
                JOptionPane.showMessageDialog(null, "Error al realizar la consulta en BD Pre productiva", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}
