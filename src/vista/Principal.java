...
public final class Principal extends javax.swing.JFrame {
    ...
    public void IconoFormulario() {
        URL url = getClass().getResource("/Imagenes/Cerrar.png");
    ...
    private void initComponents() {
        ...
        tablesomosmas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "NIT IPS", "factura", "Valor glosa inicial", "Estado final auditoria", "Valor factura"
            }
        ) {
        ...
        tablesomosmas.setPreferredSize(new java.awt.Dimension(2400, 300));
        ...
        tablesomosmas.addMouseListener(new java.awt.event.MouseAdapter() {
        ...
        jScrollPane5.setPreferredSize(new java.awt.Dimension(2400, 100));
        ...
        tableintegra.setPreferredSize(new java.awt.Dimension(2400, 300));
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(2400, 100));
        ...
        tableproductivo.setBackground(new java.awt.Color(255, 255, 255));
        ...
        tableproductivo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tableproductivo.setGridColor(new java.awt.Color(0, 0, 0));
        tableproductivo.setMinimumSize(new java.awt.Dimension(240, 0));
        tableproductivo.setPreferredSize(new java.awt.Dimension(2400, 300));
        tableproductivo.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tableproductivo.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tableproductivo.getTableHeader().setReorderingAllowed(false);
        tableproductivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableproductivoMouseClicked(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelEncabezado, javax.swing.GroupLayout.DEFAULT_SIZE, 1122, Short.MAX_VALUE)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, 1110, Short.MAX_VALUE)
                    .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1110, Short.MAX_VALUE)
    ...
    private void tableproductivoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableproductivoMouseClicked
        DefaultTableModel model = (DefaultTableModel) tableproductivo.getModel();
        int SelectedRowIndex = tableproductivo.getSelectedRow();
        String id = model.getValueAt(SelectedRowIndex, 0).toString();
        FacturaDetallesProductivo FDP = new FacturaDetallesProductivo();
        JOptionPane.showMessageDialog(null, "ID = " + id);
        String query = "SELECT * FROM cm_detalles WHERE cm_facturas_id = ? ";
        FDP.busquedaDetalles(id, query);
        FDP.buscarDatosGlosa(id);
        if (FDP.Estado()) {
            FDP.show(true);
        }
    }//GEN-LAST:event_tableproductivoMouseClicked

    private void DetalleSomosMas(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DetalleSomosMas
        DefaultTableModel model = (DefaultTableModel) tablesomosmas.getModel();
        int SelectedRowIndex = tablesomosmas.getSelectedRow();
        String factura = model.getValueAt(SelectedRowIndex, 1).toString();
        String nit_ips = model.getValueAt(SelectedRowIndex, 2).toString();
        FacturaDetalles FD = new FacturaDetalles();
        FD.busquedaDatosSomosMasDetalles(factura, nit_ips);
        if (FD.Estado()) {
            FD.show(true);
        }
    }//GEN-LAST:event_DetalleSomosMas
